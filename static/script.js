...
function greetingFunc() {
    ...
    if (h >= 5 && h < 12) {
        E.innerHTML = " Good morning, I am Lillian Zhao";
    } else if (h >= 12 && h < 18) {
        E.innerHTML += " Good afternoon, I am Lillian Zhao";
    } else if (h >= 18 && h < 20) {
        E.innerHTML = " Good evening, I am Lillian Zhao";
    } else {
        E.innerHTML = "Good night, I am Lillian Zhao";
    }
}
...
async function initMap() {
    ...
    const position = { lat: 45.7567, lng: 126.6424 };
